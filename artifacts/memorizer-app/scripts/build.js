...
function getDeploymentDomain() {
  const domain = process.env.DEPLOYMENT_DOMAIN || process.env.EXPO_PUBLIC_DOMAIN;
  if (domain) return stripProtocol(domain);

  console.error("ERROR: Set DEPLOYMENT_DOMAIN to the public hostname for this build.");
  process.exit(1);
}
